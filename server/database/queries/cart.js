...
module.exports = {
  ...
  getCartTotal: (userName) => connection.query('SELECT SUM(quantity * price) AS total FROM cart INNER JOIN products ON cart.id = products.id WHERE username = ?', [userName]),
};
